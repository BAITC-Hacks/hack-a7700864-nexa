...
Рабочее full-stack приложение Nexa. Полная документация, установка и demo-сценарий находятся в [корневом README](../README.md).
...
Ниже сохранены технические заметки рантайма для локальной разработки и публикации.
